...
import { URL_API_SERVICE3 } from "../../config/config.ts";
...
export default function SignInForm() {
  ...
  async function login() {
    ...
    try {
      const response = await axios.post(`${URL_API_SERVICE3}/jwt/create`, {
        email,
        password,
      });
      ...
      //const user = await axios.get(`${URL_API_SERVICE3}/jwt/`)

      setToken(decoded);
      await MessageSwal.fire({
        icon: "success",
        title: "¡Exitoso!",
